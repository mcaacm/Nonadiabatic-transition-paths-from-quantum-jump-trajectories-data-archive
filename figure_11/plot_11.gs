...
set yrange [0:0.65]
a = 0.123646*27.2113
set label 'a)' at 1.0,0.45 font "Times-Roman,24"
set label 'b)' at 4.0,0.25 font "Times-Roman,24"
plot "fig_11_path_to_B.txt" u ($1-1):($2*27.2113 - a) with lines lw 6 lc "black" notitle, "fig_11_path_to_B.txt" u ($1-1):($2*27.2113 -a) pt 5 ps 3 lc "black" notitle
unset label
...
set surface
set view map
splot "fig_11_wfn_50.txt" u ($2/Q0):($1/Q0):($4 < 0.001 ? 1/0 : -log10($4))  with pm3d at b notitle
...
splot "fig_11_wfn_50.txt" u ($2/Q0):($1/Q0):($3 < 0.001 ? 1/0 : -log10($3)) with pm3d at b notitle 
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
...
set surface
set view map
splot "fig_11_wfn_22.txt" u ($2/Q0):($1/Q0):($4 < 0.001 ? 1/0 : -log10($4))  with pm3d at b notitle
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
...
#set palette defined (10 '#ffffff', 20 '#fddbc7', 30 '#f4a582', 40 '#d6604d', 50 '#b2182b', 60 '#67001f')  # For nonlog
set palette defined (20 '#67001f', 30 '#b2182b', 40 '#d6604d', 50 '#f4a582', 60 '#ffffff') #,110 '#053061') # For log
splot "fig_11_wfn_22.txt" u ($2/Q0):($1/Q0):($3 < 0.001 ? 1/0 : -log10($3)) with pm3d at b notitle 
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
...
set terminal postscript enhanced colour font "Times-Roman,20"
Q0 = (4.168748375 + 4.729342937)/2.0
kappa1 = -0.003858675*3.0
kappa2 = 0.0054756457*2.4
omegasc = 0.0043364174
omegast = 0.0027194482
...
set yrange [0:0.81]
a = 0.123646*27.2113
set label 'a)' at 1.0,0.6 font "Times-Roman,24"
set label 'b)' at 3.8,0.35 font "Times-Roman,24"
plot "fig_11_path_to_1.txt" u ($1-1):($2*27.2113 - a) with lines lw 6 lc "black" notitle, "fig_11_path_to_1.txt" u ($1-1):($2*27.2113 -a) pt 5 ps 3 lc "black" notitle
unset label
reset
...
set surface
set view map
splot "fig_11_wfn_82.txt" u ($2/Q0):($1/Q0):($4 < 0.001 ? 1/0 : -log10($4))  with pm3d at b notitle
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
...
#set palette defined (10 '#ffffff', 20 '#fddbc7', 30 '#f4a582', 40 '#d6604d', 50 '#b2182b', 60 '#67001f')  # For nonlog
set palette defined (20 '#67001f', 30 '#b2182b', 40 '#d6604d', 50 '#f4a582', 60 '#ffffff') #,110 '#053061') # For log
splot "fig_11_wfn_82.txt" u ($2/Q0):($1/Q0):($3 < 0.001 ? 1/0 : -log10($3)) with pm3d at b notitle 
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
...
splot "fig_11_wfn_44.txt" u ($2/Q0):($1/Q0):($4 < 0.001 ? 1/0 : -log10($4))  with pm3d at b notitle
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
...
#set palette defined (10 '#ffffff', 20 '#fddbc7', 30 '#f4a582', 40 '#d6604d', 50 '#b2182b', 60 '#67001f')  # For nonlog
set palette defined (20 '#67001f', 30 '#b2182b', 40 '#d6604d', 50 '#f4a582', 60 '#ffffff') #,110 '#053061') # For log
splot "fig_11_wfn_44.txt" u ($2/Q0):($1/Q0):($3 < 0.001 ? 1/0 : -log10($3)) with pm3d at b notitle 
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
