...
REAL*8, PARAMETER :: lambda_s = 0.0096283166d0*0.30d0 ! Diabatic coupling strength
...
! Plotting bounds
INTEGER, PARAMETER :: bound1 = 82
INTEGER, PARAMETER :: bound2 = 82
INTEGER, PARAMETER :: bound3 = 44
INTEGER, PARAMETER :: bound4 = 49
