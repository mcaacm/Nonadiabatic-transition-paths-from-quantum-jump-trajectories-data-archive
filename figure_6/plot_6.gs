...
# Lower and upper adiabatic surfaces
...
set yrange [0:0.65]
a = 0.1228*27.2113
set label 'a)' at 3.05,0.35 font "Times-Roman,24"
set label 'b)' at 4.10,0.40 font "Times-Roman,24"
plot "fig_6_pathway_energies.txt" u 1:($2*27.2113 - a) with lines lw 6 lc "black" notitle, "fig_6_pathway_energies.txt" u 1:($2*27.2113 -a) pt 5 ps 3 lc "black" notitle
unset label
...
set surface
set view map
splot "fig_6_pre_committor_wf.txt"  u ($2/Q0):($1/Q0):($4 < 0.001 ? 1/0 : -log10($4))  with pm3d at b notitle
...
splot "fig_6_pre_committor_wf.txt" u ($2/Q0):($1/Q0):($3 < 0.001 ? 1/0 : -log10($3)) with pm3d at b notitle 
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
...
set surface
set view map
splot "fig_6_post_committor_wf.txt" u ($2/Q0):($1/Q0):($4 < 0.001 ? 1/0 : -log10($4))  with pm3d at b notitle
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
...
#set palette defined (10 '#ffffff', 20 '#fddbc7', 30 '#f4a582', 40 '#d6604d', 50 '#b2182b', 60 '#67001f')  # For nonlog
set palette defined (20 '#67001f', 30 '#b2182b', 40 '#d6604d', 50 '#f4a582', 60 '#ffffff') #,110 '#053061') # For log
splot "fig_6_post_committor_wf.txt" u ($2/Q0):($1/Q0):($3 < 0.001 ? 1/0 : -log10($3)) with pm3d at b notitle 
set cntrparam levels incremental 0.120,0.005,0.20
set cntrlabel start 5 interval 100 onecolor
unset surface
set contour
